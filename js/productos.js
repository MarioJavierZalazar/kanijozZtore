...
const grillaDePorductosUI = (lista) =>{
    for (const product of lista) {
        ...
        <div class="col-12 col-md-3 mb-5 rounded">
                <div class="cardImg">
                    <img src=${product.picture} class="card-img-top img-fluid" alt=${product.name} data-bs-toggle="modal" data-bs-target="#modal${product.name}">
                </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="modal${product.name}" tabindex="-1" aria-hidden="true">
